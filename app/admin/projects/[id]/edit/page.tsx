...
export default function EditProjectPage() {
  ...
  return (
    <div>
      <h1 className="font-display text-3xl mb-8">编辑项目</h1>
      <form onSubmit={handleSubmit} className="max-w-3xl">
        <BrutalInput label="项目名称" value={title} onChange={setTitle} required />
        ...
        />
        <BrutalInput label="技术栈" value={techStack} onChange={setTechStack} />
